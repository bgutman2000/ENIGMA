function [q_list, scale_list, hits, overall_scale] = print_all_hits_global_FDR(P_all, BETAS_all, model_name, out_dir)%1 - thickness, 2 - Jacobian
% 
% display(model_name);
% return
...
for RID=1:2
    ...
    for i = 1:length(ROI_ids)
        ...
        if(q_list(i,RID) > 0)
            ...
            plot_FDR_q(p',style{tot_hits+1}, f_hold, q_control);
