function [q_list, scale_list, hits, overall_scale] = print_all_hits_SL(P_all, BETAS_all, model_name, out_dir)%1 - thickness, 2 - Jacobian
% 
% display(model_name);
% return
Q_ctrl = 0.05;
...
for i=1:14    
    coords{i} = get_atlas_coords(ROI_ids(i));
end
