function [P, BETA, D, R] = read_all_sites_csv_stats(prefix, file_names, postfix,factor_names)
...
for i = 1:length(file_names)
    ...
    for j=1:length(ROI_ids)
       ...
       if(j == 1)
        ...
        [p_vals, betas, D_vals, R_vals] = read_single_stat_csv_mega2(LogJacs_name, main_factor_name, 'LogJacs');        
        ...
        [p_vals2, betas2, D_vals2, R_vals2] = read_single_stat_csv_mega2(thick_name, main_factor_name, 'thick');        
